...
//////// Constants //////////////
// const s3URL = `https://bizopsconfigurator.s3.amazonaws.com/dashboardpack-latest.json`;
const s3URL = `https://d232y8dk2ekhj5.cloudfront.net/dashboardpack-latest.json`;
...
var repoList = [
  ...
  { 'owner': 'JalenBattleDT', 'repo': 'D1Dashboards', 'path': '' },
...
var usecases = [
  ...
  { name: "Playground", bizAnalytics: true, prefix: "a021" }
];
//////// Global Vars ////////////
